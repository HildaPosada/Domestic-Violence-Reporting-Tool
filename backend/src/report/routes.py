...
@report_router.get("/{username}", response_model=List[ReportResponseModel])
...
@report_router.get("/{report_id}", response_model=ReportResponseModel)
...
@report_router.post("/create-report/{user_id}", response_model=status.HTTP_201_CREATED)
...
@report_router.put("/update/{user_id}/{report_id}", response_model=status.HTTP_200_OK)
...
@report_router.get("/get-all-follow-up-reports/{report_id}", response_model=List[Follow_Up_Response_Model])
...
@report_router.post("/add-follow-up/{report_id}", response_model=status.HTTP_201_CREATED)
